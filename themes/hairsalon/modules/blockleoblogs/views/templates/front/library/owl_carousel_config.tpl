...
$(document).ready(function() {
    $("{$call_owl_carousel}").owlCarousel({
            ...
            rewindNav : {if $owl_rewindNav}true{else}false{/if}, // enable, disable go back to first item
            ...
            lazyFollow : {if $owl_lazyFollow}true{else}false{/if},  // true : go to page 7th and load all images page 1...7. false : go to page 7th and load only images of page 7th
