...
{if !isset($email_create)}
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box panel panel-default">
				<h3 class="panel-heading">{l s='Create an account'}</h3>
		...
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix form-horizontal">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					{/if}
					<h3 class="page-subheading bottom-indent top-indent">{l s='Delivery address'}</h3>
					{foreach from=$dlv_all_fields item=field_name}
						...
						{elseif $field_name eq "vat_number"}
							<div id="vat_number" style="display:none;">
								<div class="form-group">
									<label class="control-label col-sm-4" for="vat-number">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
									<div class="col-sm-6">
						...
						{elseif $field_name eq "address2"}
							<div class="form-group is_customer_param">
								<label class="control-label col-sm-4" for="address2">{l s='Address (Line 2)'} {if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
								<div class="col-sm-6">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						{if $field_name eq "company"}
						<div class="form-group">
							<label class="control-label col-sm-4" for="company_invoice">{l s='Company'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
							<div class="col-sm-6">
						...
						<div id="vat_number_block_invoice" style="display:none;">
							<div class="form-group">
								<label class="control-label col-sm-4" for="vat_number_invoice">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
								<div class="col-sm-6">
						...
						<div class="required form-group dni_invoice">
							<label class="control-label col-sm-4" for="dni_invoice">{l s='Identification number'} <sup>*</sup></label>
							<div class="col-sm-6">
						...
						{elseif $field_name eq "address2"}
						<div class="form-group is_customer_param">
							<label class="control-label col-sm-4" for="address2_invoice">{l s='Address (Line 2)'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
							<div class="col-sm-6">
			...
			<div class="account_creation">
				...
				{foreach from=$dlv_all_fields item=field_name}
					...
					{elseif $field_name eq "vat_number"}
						<div id="vat_number" style="display:none;">
							<div class="form-group">
								<label class="control-label col-sm-4" for="vat_number">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
								<div class="col-sm-6">
