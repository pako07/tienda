...
{if $products}
    {if !$refresh}
        ...
        <a id="hideWishlist" class="button_account icon"  href="#" onclick="WishlistVisibility('wishlistLinkTop', 'Wishlist'); return false;" rel="nofollow" title="{l s='Close this wishlist' mod='blockwishlist'}">
        ...
        <p class="submit">
            <div id="showSendWishlist">
                <a class="btn btn-outline button button-small btn-sm" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
                        ...
                        <div class="col-xs-6 col-sm-12">
                            <div class="product_infos">
                                ...
                                <div class="btn_action">
                                    <a class="btn btn-outline button button-small btn-sm"  href="javascript:;" onclick="WishlistProductManage('wlp_bought_{$product.id_product_attribute}', 'update', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" title="{l s='Save' mod='blockwishlist'}">
