...
{if $telnumber}
	<span class="shop-phone{if isset($is_logged) && $is_logged} is_logged{/if} hidden-sm hidden-xs">
		<i class="fa fa-phone"></i>{l s='Call us now:' mod='blockcontact'} <strong>{$telnumber}</strong> {l s='for us' mod='blockcontact'}
	</span>
{/if}