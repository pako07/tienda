	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box form-horizontal">
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="login_passwd">{l s='Password'}</label>
					<div class="col-sm-6 col-md-6">
                ...
                <div class="form-group">
					<div class="col-sm-offset-4 col-sm-8 col-md-offset-4 col-md-8">
						...
						<p class="submit">
							...
							<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-outline button-medium"><span><i class="fa fa-lock left"></i>{l s='Sign in'}</span></button>
						</p>
					</div>
				</div>
			</div>
		...
		<fieldset>
        	<div class="box">
				...
				<div class="required password is_customer_param form-group">
					<label class="control-label col-sm-4 col-md-4" for="passwd">{l s='Password'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
...
{if array_key_exists('optin', $field_required)}
				...
				<div id="vat_number_block" style="display:none;">
					<div class="form-group">
						<label class="control-label col-sm-4 col-md-4" for="vat_number">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
						<div class="col-sm-6 col-md-6">
				...
				<div class="required dni form-group">
					<label class="control-label col-sm-4 col-md-4" for="dni">{l s='Identification number'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
				...
				<div class="required text form-group">
					<label class="control-label col-sm-4 col-md-4" for="address1">{l s='Address'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
				...
				<div class="text{if !in_array($field_name, $required_fields)} is_customer_param{/if} form-group">
					<label class="control-label col-sm-4 col-md-4" for="address2">{l s='Address (Line 2)'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
					<div class="col-sm-6 col-md-6">
				...
				<div class="required postcode text form-group">
					<label class="control-label col-sm-4 col-md-4" for="postcode">{l s='Zip / Postal code'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
				...
				<div class="required id_state form-group" style="display:none;">
					<label class="control-label col-sm-4 col-md-4" for="id_state">{l s='State'} <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
				...
				<div class="form-group is_customer_param">
					<label class="control-label col-sm-4 col-md-4" for="other">{l s='Additional information'}</label>
					<div class="col-sm-6 col-md-6">
						<textarea class="form-control" name="other" id="other" cols="26" rows="7"></textarea>
					</div>
				</div>
				<div class="form-group is_customer_param">
					<label class="control-label col-sm-4 col-md-4" for="phone">{l s='Home phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
					<div class="col-sm-6 col-md-6">
				...
				<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
					...
					{if isset($one_phone_at_least) && $one_phone_at_least}
						...
						<div class="inline-infos required"><label class="col-sm-offset-4 col-sm-6 col-md-offset-4 col-md-6">** {l s='You must register at least one phone number.'}</label></div>
					{/if}
				...
				<div id="opc_invoice_address" class="is_customer_param">
					...
					<div id="vat_number_block_invoice" class="is_customer_param" style="display:none;">
						<div class="form-group">
							<label class="control-label col-sm-4 col-md-4" for="vat_number_invoice">{l s='VAT number'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
							<div class="col-sm-6 col-md-6">
					...
					<div class="required form-group dni_invoice">
						<label class="control-label col-sm-4 col-md-4" for="dni_invoice">{l s='Identification number'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					{elseif $field_name eq "firstname"}
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="firstname_invoice">{l s='First name'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					{elseif $field_name eq "lastname"}
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="lastname_invoice">{l s='Last name'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					{elseif $field_name eq "address1"}
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="address1_invoice">{l s='Address'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					<div class="form-group {if !in_array($field_name, $required_fields)} is_customer_param{/if}">
						<label class="control-label col-sm-4 col-md-4" for="address2_invoice">{l s='Address (Line 2)'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
						<div class="col-sm-6 col-md-6">
					...
					<div class="required postcode_invoice form-group">
						<label class="control-label col-sm-4 col-md-4" for="postcode_invoice">{l s='Zip / Postal Code'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					{elseif $field_name eq "city"}
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="city_invoice">{l s='City'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					{elseif $field_name eq "country" || $field_name eq "Country:name"}
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4" for="id_country_invoice">{l s='Country'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					<div class="required id_state_invoice form-group" style="display:none;">
						<label class="control-label col-sm-4 col-md-4" for="id_state_invoice">{l s='State'} <sup>*</sup></label>
						<div class="col-sm-6 col-md-6">
					...
					{/if}
					<div class="form-group is_customer_param">
						<label class="control-label col-sm-4 col-md-4" for="other_invoice">{l s='Additional information'}</label>
						<div class="col-sm-6 col-md-6">
							<textarea class="form-control" name="other_invoice" id="other_invoice" cols="26" rows="3"></textarea>
						</div>
					</div>
					{if isset($one_phone_at_least) && $one_phone_at_least}
						<div class="inline-infos required is_customer_param"><label class="col-sm-offset-4 col-sm-6 col-md-offset-4 col-md-6">{l s='You must register at least one phone number.'}</label></div>
					{/if}					
					<div class="form-group is_customer_param">
						<label class="control-label col-sm-4 col-md-4" for="phone_invoice">{l s='Home phone'}</label>
						<div class="col-sm-6 col-md-6">
					...
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
						<label class="control-label col-sm-4 col-md-4" for="phone_mobile_invoice">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
						<div class="col-sm-6 col-md-6">
