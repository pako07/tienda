...
<h1 id="cart_title" class="page-heading">{l s='Shopping-cart summary'}</h1>
	{if !isset($empty) && !$PS_CATALOG_MODE}
		<small class="heading-counter">{l s='Your shopping cart contains:'}
										...
										<div class="cart_quantity_button clearfix">
											{if $product.minimal_quantity < ($customization.quantity -$quantityDisplayed) OR $product.minimal_quantity <= 1}
												<a
													...
													class="cart_quantity_down btn btn-outline button-minus btn-sm"
											...
											{else}
												<a
													...
													class="cart_quantity_down btn btn-outline button-minus btn-sm disabled"
													href="#"
													title="{l s='Subtract'}">
													<span><i class="fa fa-minus"></i></span>
												</a>
											...
											<a
												...
												class="cart_quantity_up btn btn-outline button-plus btn-sm"
