<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 11:40:38
         compiled from "C:\wamp\www\Mitienda\themes\ap_juice\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2127557ab59060ebab8-00006763%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dba16feef83626e0a5193ff3d262a80594a1afa0' => 
    array (
      0 => 'C:\\wamp\\www\\Mitienda\\themes\\ap_juice\\modules\\blockcart\\blockcart.tpl',
      1 => 1470840274,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2127557ab59060ebab8-00006763',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab590699f117_03866041',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab590699f117_03866041')) {function content_57ab590699f117_03866041($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\Mitienda\\tools\\smarty\\plugins\\modifier.replace.php';
...
<div class="blockcart_top clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
	<div id="cart" class="shopping_cart">
		<a class="heading-cart" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink($_smarty_tpl->tpl_vars['order_process']->value,true), ENT_QUOTES, 'UTF-8', true);?>
...
" rel="nofollow">
			...
			<span class="ajax_cart_total<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value==0) {?> unvisible<?php }?> hidden-sp">
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
						...
						<p class="cart-buttons clearfix">
							<a id="button_order_cart" class="btn btn-outline button pull-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>
				...
				<div class="button-container">	
					<span class="continue btn btn-outline btn-sm button exclusive-medium" title="<?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart'),$_smarty_tpl);?>
">
						<span>
					...
					<a class="btn btn-outline btn-sm button pull-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
