<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 11:33:38
         compiled from "C:\wamp\www\Mitienda\modules\appagebuilder\views\templates\hook\ProductOwlCarousel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1182557ab5762482ff1-88463091%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '216b9ceca5d2a713d4aff69a682d8e95040ec1b9' => 
    array (
      0 => 'C:\\wamp\\www\\Mitienda\\modules\\appagebuilder\\views\\templates\\hook\\ProductOwlCarousel.tpl',
      1 => 1470840277,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1182557ab5762482ff1-88463091',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab5762685e64_06814971',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab5762685e64_06814971')) {function content_57ab5762685e64_06814971($_smarty_tpl) {?>
<!-- @file modules\appagebuilder\views\templates\hook\ProductOwlCarousel -->
<div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['carouselName']->value, ENT_QUOTES, 'UTF-8', true);?>
" class="owl-carousel owl-theme owl-loading <?php if (isset($_smarty_tpl->tpl_vars['productClassWidget']->value)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['productClassWidget']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>">
...
<?php } else { ?>false<?php }?>,
            <?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['itemsdesktop'])) {?>itemsDesktop : [1199,<?php echo intval($_smarty_tpl->tpl_vars['formAtts']->value['itemsdesktop']);?>
],<?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['itemsdesktopsmall'])) {?>itemsDesktopSmall : [979,<?php echo intval($_smarty_tpl->tpl_vars['formAtts']->value['itemsdesktopsmall']);?>
],<?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['itemstablet'])) {?>itemsTablet : [768,<?php echo intval($_smarty_tpl->tpl_vars['formAtts']->value['itemstablet']);?>
],<?php }?>

            <?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['itemsmobile'])) {?>itemsMobile : [479,<?php echo intval($_smarty_tpl->tpl_vars['formAtts']->value['itemsmobile']);?>
],<?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['formAtts']->value['itemscustom'])) {?>itemsCustom : <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['formAtts']->value['itemscustom'], ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
