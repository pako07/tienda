<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 11:33:39
         compiled from "C:\wamp\www\Mitienda\themes\ap_food\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1949357ab5763b22916-39674427%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b243dbeb268cbf8c1d08bdce77a378312089e44' => 
    array (
      0 => 'C:\\wamp\\www\\Mitienda\\themes\\ap_food\\modules\\blockcart\\blockcart.tpl',
      1 => 1470845898,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1949357ab5763b22916-39674427',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab576446eb50_59176485',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab576446eb50_59176485')) {function content_57ab576446eb50_59176485($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\Mitienda\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'C:\\wamp\\www\\Mitienda\\tools\\smarty\\plugins\\function.counter.php';
?>
<!-- MODULE Block cart -->
...
" rel="nofollow">
 ...
 - </span>
					<span class="ajax_cart_product_txt_s<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'item(s)','mod'=>'blockcart'),$_smarty_tpl);?>
 - </span>
					...
					<span class="ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'0 item(s)','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
...
" /></a>
										<div class="cart-info">
											<div class="product-name"><a class="cart_block_product_name" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['product']->value,$_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['category'],null,null,$_smarty_tpl->tpl_vars['product']->value['id_shop'],$_smarty_tpl->tpl_vars['product']->value['id_product_attribute']), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['name'],15,'...'), ENT_QUOTES, 'UTF-8', true);?>
</a>
												<span class="quantity-formated">&nbsp;x&nbsp;<span class="quantity"><?php echo $_smarty_tpl->tpl_vars['product']->value['cart_quantity'];?>
</span></span>
...
"></span>
				<span class="title">
					<i class="fa fa-ok"></i><?php echo smartyTranslate(array('s'=>'Product successfully added to your shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
...
<?php }?>
				...
				<div class="button-container">	
					<span class="continue btn btn-outline button exclusive-medium" title="<?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart'),$_smarty_tpl);?>
">
						<span>
					...
					<a class="btn btn-inverse button pull-right"	href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
