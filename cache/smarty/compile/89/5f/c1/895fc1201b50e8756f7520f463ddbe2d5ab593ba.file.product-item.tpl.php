<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 11:33:37
         compiled from "C:\wamp\www\Mitienda\themes\ap_food\sub\product-item\product-item.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2106657ab5761ce6e05-88606684%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '895fc1201b50e8756f7520f463ddbe2d5ab593ba' => 
    array (
      0 => 'C:\\wamp\\www\\Mitienda\\themes\\ap_food\\sub\\product-item\\product-item.tpl',
      1 => 1470845902,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2106657ab5761ce6e05-88606684',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab576221a799_55170865',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab576221a799_55170865')) {function content_57ab576221a799_55170865($_smarty_tpl) {?>
...
" itemprop="url">
				<img class="replace-2x img-responsive" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'food_home_default'), ENT_QUOTES, 'UTF-8', true);?>
...
"></span>
			...
			<div class="Buttons StyleC">
				<?php if (isset($_smarty_tpl->tpl_vars['quick_view']->value)&&$_smarty_tpl->tpl_vars['quick_view']->value) {?>
					<a class="quick-view btn btn-inverse" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
								...
								<a class="cart button ajax_add_to_cart_button btn" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,Smarty::$_smarty_vars['capture']['default'],false), ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>">
							...
							<?php } else { ?>
								<div class="cart btn btn-outline disabled" title="<?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>
">
									<i class="fa fa-plus-circle"></i>
