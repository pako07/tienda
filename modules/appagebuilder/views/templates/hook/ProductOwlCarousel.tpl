...
$(window).load(function(){
	$('#{$carouselName|escape:'html':'UTF-8'}').owlCarousel({
            ...
            {if isset($formAtts.itemsdesktop)}itemsDesktop : [1199,{$formAtts.itemsdesktop|intval}],{/if}
            {if isset($formAtts.itemsdesktopsmall)}itemsDesktopSmall : [979,{$formAtts.itemsdesktopsmall|intval}],{/if}
            {if isset($formAtts.itemstablet)}itemsTablet : [768,{$formAtts.itemstablet|intval}],{/if}

            {if isset($formAtts.itemsmobile)}itemsMobile : [479,{$formAtts.itemsmobile|intval}],{/if}
            {if isset($formAtts.itemscustom)}itemsCustom : {$formAtts.itemscustom|escape:'html':'UTF-8'},{/if}
